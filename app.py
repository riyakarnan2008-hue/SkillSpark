...
if len(st.session_state.messages) == 0:
    ...
    st.info("Hello! I'm SkillSpark AI. How can I help you today?")
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            with st.spinner("SkillSpark AI is thinking..."):
                ...
                response = client.chat.completions.create(
                    ...
                    messages=[

                        {
                            "role": "system",
                            "content": """
You are SkillSpark AI, a helpful, friendly, and intelligent AI assistant.
